                ...
                <form action="{{ route('variable-product.content.update') }}" class="form-update-variable-product">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <td>
                                <div class="form-group d-flex align-items-center">
                                    <input type="text" name="content" value="{{$vp->content}}" placeholder="Contenido" class="form-control">
                                </div>
                            </td>
                            <td>
                                <div class="form-group d-flex align-items-center">
                                    <input type="text" name="order" value="{{$vp->order}}" class="form-control">
                                </div>
                            </td>
                            <td>
...
@endif
<div class="card card-primary">
    <div class="card-header">Detalles de producto</div>
    <div class="card-body">
        <form action="{{ route('variable-product.content.store') }}" class="form-store-variable-product">
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <td>
                        <div class="form-group">
                            <input type="text" name="content" placeholder="Contenido" class="form-control">
                        </div>
                    </td>
                    <td>
                        <div class="form-group d-flex align-items-center">
